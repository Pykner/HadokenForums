...
<html>
    <head>
        <title>HadokenForums - Create Resource</title>
    ...
    <div class="bodyinner">
        ...
        <?php
            ...
            if(isset($_SESSION['username']) == false)
            {
                ...
                echo 'Sorry, you have to be <a href="../register.php">signed in</a> to submit a resource.';
            }
            else
            {                
                if(!$risultatogames)
                {
                    echo'<h1>Games could not be displayed</h1>';
                            ...
                            echo '<form method="post" action="../scripts/newresource.script.php">
                                <h2 id="prompt">Insert Resource title</h2>
                            ...
                            echo '<h2 id="prompt">Resource description:</h2> 
                                <textarea name="resource_content" required /></textarea><br>
                                
                                <h2 id="prompt">Resource link:</h2> 
                                <input type="text" name="link" style="width: 20%;"/><br>
                                <input class="btnForm" type="submit" value="Create resource" />
                            </form>';
            }
        }
