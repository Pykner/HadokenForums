...
<html>
    <head>
        <title>HadokenForums - Majors</title>
            ...
            $risultatogames = $mydb->query($querygames);
                ...
                {                
                                ...
                                echo '<h2 id="prompt">Tournament description:</h2> 
                                    ...
                                    echo'<input type="radio" name="online" value="0" required/><label style="color: white;" for="online">ONLINE</label>' ;
                                    echo'<input type="radio" name="online" value="1" required/><label style="color: white;" for="online">OFFLINE</label><br><br>';
                                    ...
                                    echo'<input class="btnForm" type="submit" value="Create topic" />
